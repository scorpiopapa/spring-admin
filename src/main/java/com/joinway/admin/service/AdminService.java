...
import com.joinway.admin.bean.form.PushHtmlForm;
...
//		}
	...
	@Transactional(propagation=Propagation.NOT_SUPPORTED,readOnly=true)
	public PushView push(PushHtmlForm form) throws Exception {
//		log.debug("******************{}", new String(form.getHtml().getBytehongs(), "GBK"));
		
		pushService.broadcast(form.getMessage(), form.getHtml());
